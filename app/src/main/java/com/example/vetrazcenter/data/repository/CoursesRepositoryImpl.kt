...
import com.example.vetrazcenter.core.Constants.CATEGORIES
import com.example.vetrazcenter.core.Constants.COURSES
import com.example.vetrazcenter.core.Constants.NAME
...
class CoursesRepositoryImpl @Inject constructor(
    ...
    override fun getCoursesListByCategory(category: String) = callbackFlow {
        val snapshotListener = database.collection(CATEGORIES)
